...
def write_happy_inside_circle(text_color, x, y):
    ...
    my_turtle_cursor.write("Happy", font=("sans-serif", 14, "bold"))
...
def write_birthday_inside_circle(text_color, x, y):
    ...
    my_turtle_cursor.write("Birthday Ika! <3", font=("sans-serif", 14, "bold"))
...
parts_of_cake = []
parts_of_cake.append(["#7B3F00", "#000000", 3, 50])
parts_of_cake.append(["white", "#000000", 3, 25])
parts_of_cake.append(["#7B3F00", "#000000", 3, 50])
...
draw_toppings_on_cake("red", "#000000", -120, y_coordinate - 60, 10)
draw_toppings_on_cake("red", "#000000", -80, y_coordinate - 60, 10)
draw_toppings_on_cake("red", "#000000", 50, y_coordinate - 60, 10)
draw_toppings_on_cake("red", "#000000", 90, y_coordinate - 60, 10)

# drawing middle topping of our cakes
# Drawing candle on of our cake using draw_candle_for_cake() function
draw_candle_for_cake("#FFF44F", "#000000", -30, y_coordinate - 60)

# Drawing stick on top og uou candle
draw_stick_on_candle("#181A18", -18, y_coordinate + 14, 7)
